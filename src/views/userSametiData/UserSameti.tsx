  ...
  const renderUser = ({item, index}: {item: any; index: any}) => {
    return (
      <View style={styles.dataContainer}>
        <PersonList
          data={item}
          condition={index !== openUser}
          onRightPress={() => onIconPress(index)}
        />
        {index === openUser && (
          <View style={styles.amountContainer}>
            <CheckBoxController
              label="Share Amount:- 500"
              control={control}
              controllerName={'shareAmount'}
              checkColor={colors.darkGray}
            />
            ...
            <View style={styles.amountType}>
              ...
              <View style={styles.buttonView}>
                <Pressable
                  ...
                  onPress={() => onPaymentTypePress('case')}>
                  <AppText
                    style={[
                      styles.buttonText,
                      {
                ...
                <Pressable
                  ...
                  onPress={() => onPaymentTypePress('online')}>
                  <AppText
                    style={[
                      styles.buttonText,
                      {
            ...
            {paymentType === 'case' && (
              <View style={styles.caseStructureContainer}>
                <AppText fontFamily={'bold'} style={styles.caseStructureTitle}>
                  Case Structure
                </AppText>
                <FlatList
                  data={CASE_TYPE}
